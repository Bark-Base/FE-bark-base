...
export async function updatePet({
  ...
  try {
    const res = await fetch(
      `${process.env.REACT_APP_BASE_URL}/api/v1/pet/${petId}`,
      {
        credentials: "include",
        mode: "cors",
        method: "PATCH",
...
export async function addContact({
  ...
  try {
    const res = await fetch(
      `${process.env.REACT_APP_BASE_URL}/api/v1/contact`,
      {
        credentials: "include",
        mode: "cors",
        method: "POST",
...
export async function getPets(ownerId) {
  try {
    const res = await fetch(
      `${process.env.REACT_APP_BASE_URL}/api/v1/pet/all/${+ownerId}`,
      {
        credentials: "include",
        method: "get",
        mode: "cors",
...
export async function updateContacts(
  ...
  try {
    const res = await fetch(
      `${process.env.REACT_APP_BASE_URL}/api/v1/contact/${+contact_id}`,
      {
        credentials: "include",
        mode: "cors",
        method: "PATCH",
